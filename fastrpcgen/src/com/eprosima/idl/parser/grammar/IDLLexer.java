...
public IDLLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("switch", this), new Integer(58));
	literals.put(new ANTLRHashString("typeprefix", this), new Integer(80));
	literals.put(new ANTLRHashString("case", this), new Integer(59));
	literals.put(new ANTLRHashString("finder", this), new Integer(95));
	literals.put(new ANTLRHashString("manages", this), new Integer(93));
	literals.put(new ANTLRHashString("interface", this), new Integer(7));
	literals.put(new ANTLRHashString("provides", this), new Integer(86));
	literals.put(new ANTLRHashString("Annotation", this), new Integer(55));
	literals.put(new ANTLRHashString("exception", this), new Integer(69));
	literals.put(new ANTLRHashString("primarykey", this), new Integer(94));
	literals.put(new ANTLRHashString("sequence", this), new Integer(62));
	literals.put(new ANTLRHashString("uses", this), new Integer(87));
	literals.put(new ANTLRHashString("consumes", this), new Integer(91));
	literals.put(new ANTLRHashString("void", this), new Integer(71));
	...
	literals.put(new ANTLRHashString("publishes", this), new Integer(90));
	literals.put(new ANTLRHashString("private", this), new Integer(21));
	literals.put(new ANTLRHashString("boolean", this), new Integer(50));
	literals.put(new ANTLRHashString("string", this), new Integer(65));
	literals.put(new ANTLRHashString("getraises", this), new Integer(83));
	literals.put(new ANTLRHashString("emits", this), new Integer(89));
	literals.put(new ANTLRHashString("custom", this), new Integer(8));
	literals.put(new ANTLRHashString("component", this), new Integer(85));
	literals.put(new ANTLRHashString("context", this), new Integer(75));
	literals.put(new ANTLRHashString("octet", this), new Integer(51));
	literals.put(new ANTLRHashString("oneway", this), new Integer(70));
	literals.put(new ANTLRHashString("long", this), new Integer(45));
	literals.put(new ANTLRHashString("ValueBase", this), new Integer(77));
	...
	literals.put(new ANTLRHashString("readonly", this), new Integer(81));
	...
	literals.put(new ANTLRHashString("fixed", this), new Integer(76));
	literals.put(new ANTLRHashString("Object", this), new Integer(53));
	literals.put(new ANTLRHashString("enum", this), new Integer(61));
	literals.put(new ANTLRHashString("home", this), new Integer(92));
	literals.put(new ANTLRHashString("multiple", this), new Integer(88));
	literals.put(new ANTLRHashString("attribute", this), new Integer(82));
	literals.put(new ANTLRHashString("char", this), new Integer(48));
	literals.put(new ANTLRHashString("union", this), new Integer(57));
	literals.put(new ANTLRHashString("local", this), new Integer(6));
	literals.put(new ANTLRHashString("const", this), new Integer(26));
	literals.put(new ANTLRHashString("setraises", this), new Integer(84));
	...
	literals.put(new ANTLRHashString("inout", this), new Integer(73));
	literals.put(new ANTLRHashString("raises", this), new Integer(74));
	literals.put(new ANTLRHashString("out", this), new Integer(72));
	literals.put(new ANTLRHashString("typeid", this), new Integer(79));
	...
	literals.put(new ANTLRHashString("wstring", this), new Integer(66));
	literals.put(new ANTLRHashString("unsigned", this), new Integer(47));
	literals.put(new ANTLRHashString("struct", this), new Integer(56));
...
tryAgain:
	...
	public final void mPREPROC_DIRECTIVE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		match('\n');
		text.setLength(_saveIndex);
		ctx.processPreprocessorLine(new String(text.getBuffer(), _begin, text.length()-_begin), getLine()); _ttype = Token.SKIP; newline();
		if ( _createToken && _token==null && _ttype!=Token.SKIP ) {
			_token = makeToken(_ttype);
			_token.setText(new String(text.getBuffer(), _begin, text.length()-_begin));
		}
